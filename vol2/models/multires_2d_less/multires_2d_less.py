...
class descriptor(torch.nn.Module):
    def __init__(self):
        ...
        self.layer_3_3 = downsample(32, 32)

        # fourth seq
        self.layer_4_1 = basic_layer(32)
        self.layer_4_2 = torch.nn.Conv2d(32, 16, 3, 1, 1, 1)
        self.layer_4_3 = downsample(32, 32)

        # fifth seq
        self.layer_5_1 = basic_layer(32)
        self.layer_5_2 = torch.nn.Conv2d(32, 16, 3, 1, 1, 1)
...
class cnn_3D(torch.nn.Module):
    def __init__(self):
        ...
        self.dres0_0 = torch.nn.Sequential(convbn_3d(160, 64, 3, 1, 1, 1),
                                           torch.nn.ReLU(inplace=True))
