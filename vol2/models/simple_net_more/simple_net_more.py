...
class cnn_3D(torch.nn.Module):
    def __init__(self):
        ...
        self.dres0 = torch.nn.Sequential(convbn_3d(64, 64, 3, 1, 1, 1),
                                         torch.nn.ReLU(inplace=True),
                                         convbn_3d(64, 64, 3, 1, 1, 1),
                                         torch.nn.ReLU(inplace=True))

        self.dres1 = torch.nn.Sequential(convbn_3d(64, 64, 3, 1, 1, 1),
                                         torch.nn.ReLU(inplace=True),
                                         convbn_3d(64, 64, 3, 1, 1, 1))

        self.dres2 = torch.nn.Sequential(convbn_3d(64, 64, 3, 1, 1, 1),
                                         torch.nn.ReLU(inplace=True),
                                         convbn_3d(64, 64, 3, 1, 1, 1))

        self.dres3 = torch.nn.Sequential(convbn_3d(64, 64, 3, 1, 1, 1),
                                         torch.nn.ReLU(inplace=True),
                                         convbn_3d(64, 64, 3, 1, 1, 1))

        self.dres4 = torch.nn.Sequential(convbn_3d(64, 64, 3, 1, 1, 1),
                                         torch.nn.ReLU(inplace=True),
                                         convbn_3d(64, 64, 3, 1, 1, 1))

        self.dres5 = torch.nn.Sequential(convbn_3d(64, 64, 3, 1, 1, 1),
                                         torch.nn.ReLU(inplace=True),
                                         convbn_3d(64, 64, 3, 1, 1, 1))

        self.classify = torch.nn.Sequential(convbn_3d(64, 64, 3, 1, 1, 1),
                                            torch.nn.ReLU(inplace=True),
                                            torch.nn.Conv3d(64, 1, 3, 1, 1,
                                                            bias=False))
