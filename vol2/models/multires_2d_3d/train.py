...
# training parameters
train_for_epochs = 185            # how many epochs to train
lr = 0.001                      # learning rate
loss_from_scales_in_training = [3/4, 1/4/4, 1/4/4, 1/4/4, 1/4/4]
...
for ep in range(init_epoch, init_epoch + train_for_epochs):
    ...
    # TEST_FULL
    if val_on_test_full:
        net.validate('test', 'full', dataset, 1, stats, model_instance, device, maxD)
    net.save_checkpoint(model_instance, optimizer, stats, save_to)
    torch.cuda.empty_cache()
