...
# TODO fix that, so that it uses relative path
...
experiment_n_load_from = 22      # directory to load_from
...
which_dataset = 'flying_tr_te_30'  # which standard dataset to load from
...
if action is 'from_scratch':
    ...
    if not get_standart_dataset:
        from_datasets = [{'kitti_2012': [160, 40, 0]},
                         {'kitti_2015': [0, 0, 0]},
                         {'freiburg_monkaa': [0, 0, 0]},
