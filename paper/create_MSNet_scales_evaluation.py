...
# first row of plots
ax[0][0].plot(results[:,0], 'ro')
ax[0][0].axvspan(-0.5, 3.5, alpha=0.5, color='blue')
ax[0][0].axvspan(3.5, 9.5, alpha=0.5, color='green')
ax[0][0].axvspan(9.5, 13.5, alpha=0.5, color='magenta')
ax[0][0].axvspan(13.5, 14.5, alpha=0.5, color='red')
ax[0][0].set_ylabel('$\mu$ Absolute Error')

ax[0][1].plot(results[:,1], 'ro')
ax[0][1].axvspan(-0.5, 3.5, alpha=0.5, color='blue')
ax[0][1].axvspan(3.5, 9.5, alpha=0.5, color='green')
ax[0][1].axvspan(9.5, 13.5, alpha=0.5, color='magenta')
ax[0][1].axvspan(13.5, 14.5, alpha=0.5, color='red')
ax[0][1].set_ylabel('$\sigma$ Absolute Error')
...
xnames = ['\{4\}', '\{8\}', '\{16\}', '\{32\}',
          ...
          '\{4,8,16,32\}']
ax[0][0].set_xticks(range(len(results[:,3])))
ax[0][0].set_xticklabels(xnames, rotation=80)
ax[0][1].set_xticklabels(xnames, rotation=80)
